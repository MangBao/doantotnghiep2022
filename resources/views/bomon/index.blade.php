...
@section('content')
    ...
    <div class="flex justify-between">
        ...
        <div class="pt-3">
            <form action="{{ route('bomon.search') }}" method="get">
                {{-- @csrf --}}
                <input
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <button
                                        onclick="event.preventDefault(); document.getElementById('popup-modal-{{ $bm->bomon_id }}').classList.add('block'); document.getElementById('popup-modal-{{ $bm->bomon_id }}').classList.remove('hidden');"
                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                        aria-label="Delete">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                            viewBox="0 0 20 20">
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                                    ...
                                    <div class="flex justify-end p-2">
                                        <span
                                            onclick="event.preventDefault(); document.getElementById('popup-modal-{{ $bm->bomon_id }}').classList.add('hidden'); document.getElementById('popup-modal-{{ $bm->bomon_id }}').classList.remove('block');"
                                    ...
                                    <div class="p-6 pt-0 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                            Bạn có chắc muốn xóa {{ $bm->tenbomon }} chứ ?
                                        </h3>
