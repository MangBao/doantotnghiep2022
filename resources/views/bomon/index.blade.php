...
@section('titleAdmin', 'Bộ môn')
@section('content-admin')
    @include('partials.breadcumb', ['page' => 'Bộ môn', 'key' => 'Index', 'link' => route('bomon.index')])
    <div class="h-12"></div>

    <div class="flex">
        <div class="mr-8 pt-3">
            <a href="{{ route('bomon.create') }}" class="btn-primary">
                Thêm Bộ môn
            </a>
        </div>
        @if (session('success'))
                        ...
                        @foreach ($bms as $bm)
                            <tr
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('bomon.edit', [$bm->bomon_id]) }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> |

                                    <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$bm->bomon_id}}').classList.add('block'); document.getElementById('popup-modal-{{$bm->bomon_id}}').classList.remove('hidden');"

                                        class="cursor-pointer font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</span>
                                </td>
                            </tr>
                            <div id="popup-modal-{{$bm->bomon_id}}" tabindex="-1"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                                    ...
                                    <div class="flex justify-end p-2">
                                        <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$bm->bomon_id}}').classList.add('hidden'); document.getElementById('popup-modal-{{$bm->bomon_id}}').classList.remove('block');"
                                            ...
                                            data-modal-toggle="popup-modal-{{$bm->bomon_id}}">
                                    ...
                                    <div class="p-6 pt-0 text-center">
                                        ...
                                        <a href="{{ route('bomon.delete', [$bm->bomon_id]) }}"
