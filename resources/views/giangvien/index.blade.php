...
@section('content-admin')
    ...
    <div class="flex">
        ...
        <div class="mr-8 pt-3">
            <span onclick="event.preventDefault(); document.getElementById('popupModalImport').classList.add('block'); document.getElementById('popupModalImport').classList.remove('hidden');"
                        ...
                        @foreach ($gvs as $gv)
                            <tr
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$gv->id}}').classList.add('block'); document.getElementById('popup-modal-{{$gv->id}}').classList.remove('hidden');"
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                                        ...
                                        <div class="flex justify-end p-2">
                                            <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$gv->id}}').classList.add('hidden'); document.getElementById('popup-modal-{{$gv->id}}').classList.remove('block');"
    ...
    <div id="popupModalImport" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                <!-- Modal header -->
                <div class="flex justify-end p-2">
                    <span onclick="event.preventDefault(); document.getElementById('popupModalImport').classList.add('hidden'); document.getElementById('popupModalImport').classList.remove('block');"
                        class="cursor-pointer text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                ...
                <div class="p-6 pt-0 text-center">
                    ...
                    <form action="{{ route('giangvien.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <button type="submit" class="text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">Import</button>
                        <span onclick="event.preventDefault(); document.getElementById('popupModalImport').classList.add('hidden'); document.getElementById('popupModalImport').classList.remove('block');"
