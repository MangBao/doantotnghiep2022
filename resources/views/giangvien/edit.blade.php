...
@include('partials.breadcumb', ['page' => 'Giảng viên', 'key' => 'Edit', 'link' => route('giangvien.index')])
<div class="h-12"></div>
            ...
            <div class="w-full lg:w-2/5 px-4 z-10 ">
                <div class="flex flex-col w-full mb-6 shadow-lg rounded-lg border-0 bg-white">
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        ...
                        <form method="POST" action="{{ route('giangvien.update', ['id' => $gv->id]) }}" enctype="multipart/form-data">
                            @csrf
