            ...
            <div class="w-full lg:w-2/5 px-4 z-10 ">
                <div class="flex flex-col w-full mb-6 shadow-lg rounded-lg border-0 bg-white">
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        {{-- {{ route('khoa.store') }} --}}
                        <form method="POST" action="{{ route('khoa.update', ['id' => $k->khoa_id]) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block text-blueGray-600 font-bold mb-2" for="tenkhoa">
                                    {{ __('Tên Khoa') }}
                                </label>
