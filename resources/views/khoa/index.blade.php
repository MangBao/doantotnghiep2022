                        ...
                        @foreach ($ks as $k)
                            <tr
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$k->khoa_id}}').classList.add('block'); document.getElementById('popup-modal-{{$k->khoa_id}}').classList.remove('hidden');"

                                        class="cursor-pointer font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</span>
                                </td>
                            </tr>
                            <div id="popup-modal-{{$k->khoa_id}}" tabindex="-1"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                                    ...
                                    <div class="flex justify-end p-2">
                                        <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$k->khoa_id}}').classList.add('hidden'); document.getElementById('popup-modal-{{$k->khoa_id}}').classList.remove('block');"
