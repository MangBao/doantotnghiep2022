                        ...
                        @foreach ($mhs as $mh)
                            <tr
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$mh->monhoc_id}}').classList.add('block'); document.getElementById('popup-modal-{{$mh->monhoc_id}}').classList.remove('hidden');"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                                    ...
                                    <div class="flex justify-end p-2">
                                        <span onclick="event.preventDefault(); document.getElementById('popup-modal-{{$mh->monhoc_id}}').classList.add('hidden'); document.getElementById('popup-modal-{{$mh->monhoc_id}}').classList.remove('block');"
