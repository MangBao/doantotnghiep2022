                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        ...
                        <form method="POST" action="{{ route('quanlyroutes.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block text-blueGray-600 font-bold mb-2" for="role_id">
                                    {{ __('Roles') }}
                                </label>
                                <select
                            ...
                            <div class="relative w-full mb-3">
                                <label class="block text-blueGray-600 font-bold mb-2" for="route_id">
                                    {{ __('Routes') }}
                                </label>
                                <select
                                    class="border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all"
