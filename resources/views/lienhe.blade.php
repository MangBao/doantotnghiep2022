...
@section('contentHome')
    <div
        class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg border-b dark:border-gray-700 dark:text-gray-400 dark:bg-gray-700">
        <div class="flex flex-col justify-between">
            <div>
                <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Chúng tôi luôn ở đây lắng nghe bạn !</h2>
        ...
        @endif" method="get">
            <div>
                <select class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline dark:border-gray-100 dark:bg-gray-700 dark:text-gray-300"
                    ...
                    <option value="">Chọn đơn vị gửi đến</option>
                    <option value="mbao.c4@gmail.com">1.Phòng Công tác Chính trị và sinh viên</option>
                    <option value="daotao@ntu.edu.vn">2.Phòng Đào tạo Đại học</option>
                    <option value="khtc@ntu.edu.vn">3.Phòng Kế hoạch - Tài chính</option>
                    <option value="khcn@ntu.edu.vn">4.Phòng Khoa học công nghệ</option>
                    <option value="dea@ntu.edu.vn">5.Phòng Hợp tác đối ngoại</option>
                    <option value="tocntt@ntu.edu.vn">6.Tổ Công nghệ Thông tin</option>
                    <option value="tttnth@ntu.edu.vn">7. TT Thí nghiệm thực hành</option>
                    <option value="ttgdqp@ntu.edu.vn">8.TT Giáo dục quốc phòng và An ninh</option>
                    <option value="tttvhtsv@ntu.edu.vn">9.TT Quan hệ doanh nghiệp và Hỗ trợ sinh viên</option>
                </select>
            </div>
            <div class="mt-8">
    ...
    <div class="h-8"></div>
    <!-- Start_Module_9063 -->
    <div class="container mx-auto dark:border-gray-700 dark:text-gray-400 dark:bg-gray-700">
        <h2 class="text-2xl mb-5">Các đơn vị chức năng</h2>
        <div id="">
            <div id="">
                <div class="tracking-wide ">
                    <p>
                        <strong>1.&nbsp;Phòng Công tác Chính trị và sinh viên: </strong>Sinh viên cần bổ sung hồ sơ,
                        in thẻ sinh viên, tạm dừng học tập, xin vào học lại, chuyển ngành, chuyển bậc, nộp hồ sơ xét
                        học bổng chế độ chính sách xã hội, thắc mắc về học bổng khuyến khích học tập, khen thưởng,
                        kỷ luật, đăng ký học thi bằng lái xe, mượn áo cử nhân chụp ảnh.
                    </p>
                    <p>
                        <strong>2. Phòng Đào tạo Đại học:</strong> Sinh viên cần đăng ký và hủy học phần, cần in
                        bảng điểm, làm giấy hoãn thi, làm giấy vào thi do hoãn thi, làm đơn chuyển đổi mã học phần,
                        nhận bằng tốt nghiệp, đăng ký mua hồ sơ học Văn bằng 2, học liên thông lên đại học hệ chính
                        quy.&nbsp;Các thông tin liên quan đến công tác tuyển sinh.
                    </p>
                    <p>
                        <strong>3.&nbsp;Phòng Kế hoạch - Tài chính:&nbsp;</strong>Đóng học phí, đóng bảo hiểm y tế,
                        bảo hiểm thân thể, lĩnh tiền học bổng
                    </p>
                    <p>
                        <strong>4. Phòng Khoa học công nghệ: </strong>Sinh viên muốn tham gia nghiên cứu khoa học
                    </p>
                    <p>
                        <strong>5. Phòng Hợp tác đối ngoại:</strong> Sinh viên muốn tìm thông tin du học, tham gia
                        trao đổi sinh viên quốc tế
                    </p>
                    <p>
                        <strong>6.&nbsp;Tổ Công nghệ Thông tin: </strong>Hỗ trợ các vấn đề liên quan đến thư điện
                        thử của sinh viên
                    </p>
                    <p>
                        <strong>7.&nbsp;Trung tâm Thí nghiệm thực hành:</strong>&nbsp;Triển khai thí nghiệm, thực
                        hành trong Trường.
                    </p>
                    <p>
                        <strong>8.&nbsp;Trung tâm Giáo dục quốc phòng và An ninh:</strong>&nbsp;Đăng ký hay hủy học
                        phần Giáo dục thể chất, Giáo dục quốc phòng – An ninh
                    </p>
                    <p>
                        <strong>9. Trung tâm Quan hệ doanh nghiệp và Hỗ trợ sinh viên:</strong>&nbsp;Sinh viên muốn
                        học các lớp kỹ năng mềm, cần việc làm ngắn hạn, cần thông tin việc làm, thông tin tuyển dụng
                    </p>
                    <p>
                        <strong>10. Khoa - Viện:</strong>&nbsp;Sinh viên cần làm đơn phúc khảo bài thi: nộp đơn tại
                        Khoa/Viện quản lý ngành học. Xin cấp giấy chứng nhận là sinh viên đang học tại trường, liên
                        hệ thư ký văn phòng khoa/viện quản lý ngành học.&nbsp;<a
                            href="https://www.ntu.edu.vn/Gioi-thieu/Co-cau-to-chuc/khoa-vien-%C4%91ao-tao"
                            target="_blank">Danh sách Khoa/Viện</a>
                    </p>
