            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach ($tts as $tt)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="{{ route('tintuc.edit', [$tt->id]) }}"
                                    ...
                                    <button
                                        onclick="event.preventDefault(); document.getElementById('popup-modal-{{ $tt->id }}').classList.add('block'); document.getElementById('popup-modal-{{ $tt->id }}').classList.remove('hidden');"
                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                        aria-label="Delete">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                            viewBox="0 0 20 20">
                        ...
                        <div id="popup-modal-{{ $tt->id }}" tabindex="-1"
                            ...
                            <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-44 animate-fadeInDown">
                                    ...
                                    <div class="flex justify-end p-2">
                                        <span
                                            onclick="event.preventDefault(); document.getElementById('popup-modal-{{ $tt->id }}').classList.add('hidden'); document.getElementById('popup-modal-{{ $tt->id }}').classList.remove('block');"
                                            ...
                                            data-modal-toggle="popup-modal-{{ $tt->id }}">
                                    ...
                                    <div class="p-6 pt-0 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                            Bạn có chắc muốn xóa tin {{ $tt->title }} chứ ?
                                        </h3>
                                        <a href="{{ route('tintuc.delete', [$tt->id]) }}"
