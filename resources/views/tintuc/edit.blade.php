            ...
            <div class="w-full lg:w-3/4 px-4 z-10 ">
                <div
                    ...
                    <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                        {{-- {{ route('tintuc.store') }} --}}
                        <form method="POST" action="{{ route('tintuc.update', [$tts->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="relative w-full mb-3">
                                ...
                                <input type="text" id="title" name="title"
                                    ...
                                    value="{{$tts->title}}" required autocomplete="title" autofocus
                                ...
                                <div class="w-2/5">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="text" name="heading1"
                                            class="dark:border-gray-100 dark:bg-gray-700 dark:text-gray-300 border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all"
                                            value="{{$tts->heading1}}" required autocomplete="name" autofocus
                                ...
                                <div class="w-2/5">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="text" name="heading2"
                                            class="dark:border-gray-100 dark:bg-gray-700 dark:text-gray-300 border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all"
                                            value="{{$tts->heading2}}" autocomplete="name" autofocus
                                            placeholder="{{ __('Nhập heading 1') }}" />
                                    </div>
                                ...
                                <div class="w-2/5">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="text" name="heading3"
                                            class="dark:border-gray-100 dark:bg-gray-700 dark:text-gray-300 border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all"
                                            value="{{$tts->heading3}}" autocomplete="name" autofocus
                                            placeholder="{{ __('Nhập heading 1') }}" />
                                    </div>
